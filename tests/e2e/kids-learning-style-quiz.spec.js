...
const SVC_URL = "https://appadaycreator.com/kids-learning-style-quiz/";
const SVC_NAME = "子どもの学習スタイル診断";

test.describe("子どもの学習スタイル診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("kids-learning-style-quiz");
